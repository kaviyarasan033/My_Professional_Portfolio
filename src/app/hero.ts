...
@Component({
  ...
  standalone: true,
  template: `
    <section id="home" aria-label="Hero - Introduction" class="relative min-h-screen flex items-center pt-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-left" #heroContent>
            ...
            <div class="hero-item mt-12 flex items-center gap-6">
              <a href="https://github.com/kaviyarasan033" target="_blank" rel="noopener noreferrer" aria-label="Visit Kaviyarasan M on GitHub" class="text-slate-500 hover:text-primary-green transition-colors">
              ...
              <a href="https://www.linkedin.com/in/kaviyarasan-m-172542299?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" aria-label="Connect with Kaviyarasan M on LinkedIn" class="text-slate-500 hover:text-primary-green transition-colors">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd" />
                </svg>
              </a>
              <a href="mailto:mkaviyarasan003@gmail.com" aria-label="Send email to Kaviyarasan M" class="text-slate-500 hover:text-primary-green transition-colors">
